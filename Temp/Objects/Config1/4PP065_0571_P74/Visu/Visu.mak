...
PANEL_HW_SOURCE_Visu=C:/Users/admin/Documents/KVBO-04-21/Simakov/prak4/Physical/Config1/Hardware.hw 
...
PAGE_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/Pages/LEDS.page \
	$(AS_PROJECT_PATH)/Logical/Visu/Pages/MOTOR.page \
...
TRE_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/Trends/Trend_4.tre 
...
$(TEMP_PATH_Visu)/page.LEDS.vco: $(AS_PROJECT_PATH)/Logical/Visu/Pages/LEDS.page $(VC_LANGUAGES_Visu)
...
$(TEMP_PATH_Visu)/page.MOTOR.vco: $(AS_PROJECT_PATH)/Logical/Visu/Pages/MOTOR.page $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -P '$(AS_PROJECT_PATH)' -ds '$(SRC_PATH_Visu)/StyleSheets/Color.vcs' -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas
...
$(TEMP_PATH_Visu)/tpr.NumPad.vco: $(AS_PROJECT_PATH)/Logical/Visu/TouchPads/NumPad.tpr
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -prj 'C:/Users/admin/Documents/KVBO-04-21/Simakov/prak4/Logical/Visu' -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas
